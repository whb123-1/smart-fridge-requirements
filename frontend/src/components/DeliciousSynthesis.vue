...
.clear-synthesis{min-width:124px;min-height:44px;padding:8px 16px;border:1px solid #8faed3;border-radius:7px;background:#eaf2fd;color:#203a5a;font-size:14px;font-weight:700;line-height:1.35;text-align:center;transition:border-color .16s,background .16s,color .16s}
...
.synthesis-result-card>footer{min-height:68px;display:flex;align-items:center;justify-content:space-between;gap:18px;padding:12px 23px;border-top:1px solid #e3e8ef}.synthesis-result-card>footer>span{color:#39755f;font-size:13px;font-weight:700}.synthesis-result-card>footer>span.warning{color:#b4535d}.start-cooking{min-width:132px;min-height:44px;padding:8px 22px;border:1px solid #8faed3;border-radius:7px;background:linear-gradient(180deg,#d4e5f8 0%,#c7dcf5 100%);box-shadow:inset 0 1px 0 rgba(255,255,255,.8),0 3px 0 #9ebdde;color:#203a5a;font-size:14px;font-weight:700;line-height:1.35;text-align:center}.start-cooking:hover:not(:disabled){background:#b9d2f0}.start-cooking:disabled{cursor:not-allowed;opacity:.45;box-shadow:none}
...
@media (max-width:760px){.synthesis-toolbar{gap:12px}.synthesis-toolbar h2{min-width:0}.clear-synthesis{flex:0 0 auto;min-width:116px}.pot-ingredient{min-height:58px;grid-template-columns:30px minmax(0,1fr) 36px}.synthesis-result-card>footer{align-items:stretch}.synthesis-error button{min-width:0}.start-cooking{width:100%}}
@media (max-width:360px){.synthesis-toolbar{align-items:stretch;flex-direction:column}.clear-synthesis{width:100%}}

...
export const api = {
  ...
  rotateDeviceCredentials: id => write(`/api/v1/devices/${id}/credentials/rotate`, 'POST', undefined, true),
  getDeviceSensors: id => request(`/api/v1/devices/${id}/sensors`),
  bindDeviceSensor: (id, payload) => write(`/api/v1/devices/${id}/sensors`, 'POST', payload, true),
  unbindDeviceSensor: (deviceId, sensorId) => write(`/api/v1/devices/${deviceId}/sensors/${sensorId}`, 'DELETE', undefined, true),
  ...
  createDebugTelemetryScenario: payload => write('/api/v1/debug/telemetry/scenarios', 'POST', payload, true),
  updateDebugTelemetryScenario: (id, payload) => write(`/api/v1/debug/telemetry/scenarios/${id}`, 'PATCH', payload, true),

...
public class RecipeController {
    ...
    @PostMapping("/recipes/generate") public ApiEnvelope<Map<String,Object>> generate(@AuthenticationPrincipal UserPrincipal p,@Valid @RequestBody RecipeContracts.GenerateRequest r){return ApiEnvelope.ok(Map.of("recipes",recipes.generate(p.userId(),r),"fallback",true));}
